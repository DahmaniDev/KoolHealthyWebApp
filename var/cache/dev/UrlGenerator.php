...
return [
    ...
    'commandePDF' => [['id'], ['_controller' => 'App\\Controller\\DefaultController::commandePDF'], [], [['variable', '/', '[^/]++', 'id'], ['text', '/commandePDF']], [], []],
    ...
    'message-sent' => [[], ['_controller' => 'App\\Controller\\DefaultController::MessageSent'], [], [['text', '/message-sent']], [], []],
    'commande-sent' => [['id'], ['_controller' => 'App\\Controller\\DefaultController::CommandeSent'], [], [['variable', '/', '[^/]++', 'id'], ['text', '/commande-sent']], [], []],
    ...
    'adminUploadRecette' => [[], ['_controller' => 'App\\Controller\\DefaultController::adminUploadRecette'], [], [['text', '/admin-kool-healthy-123456789-upload-recette']], [], []],
